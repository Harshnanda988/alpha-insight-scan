...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Bsm624G9.mjs");
...
const manifest = {
  "184428904420acb50b081828d8aed22ec91bea12ee676672715105c90973c3ff": {
    ...
    importer: () => import("./market.functions-DHu3g7gw.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CsjDKZWR.mjs").then((n) => n.r),
    import("./start-eHolP_m5.mjs"),
