import { e as create, c as createLucideIcon, a as cn$1, n as useComposedRefs, o as useLayoutEffect2, P as Primitive, O as Check, p as useDirection, q as useControllableState, r as useId, R as Root2$1, V as VISUALLY_HIDDEN_STYLES, A as Anchor, s as composeEventHandlers, v as Portal$3, w as Presence, x as reactDomExports, y as createPopperScope, z as createCollection, C as useCallbackRef$1, D as createContextScope, E as hideOthers, F as useFocusGuards, G as ReactRemoveScroll, H as FocusScope, J as DismissableLayer, K as createSlot, L as Content, N as Arrow } from "./router-ov0HDanu.mjs";
...
var SelectPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PortalProvider, { scope: props.__scopeSelect, forceMount, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$3, { asChild: true, ...portalProps }) });
};
...
const useResultsStore = create((set) => ({
  ...
  conditions: [],
  ranAt: null,
  setResults: (results, conditions, scannerName) => set({ results, conditions, scannerName, ranAt: Date.now() }),
