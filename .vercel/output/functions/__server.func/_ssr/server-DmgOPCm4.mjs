...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-EWxgN8O2.mjs");
...
const manifest = {
  "184428904420acb50b081828d8aed22ec91bea12ee676672715105c90973c3ff": {
    functionName: "fetchMarketData_createServerFn_handler",
    importer: () => import("./market.functions-BA0VHOQY.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ov0HDanu.mjs").then((n2) => n2.ac),
    import("./start-B_e8KefZ.mjs"),
